...
public:
    ...
    // Insert element at given position, throw error messege while index out of bound
    void insert(int index, int value);
    // Delete element at given position, throw error messege while index out of bound
